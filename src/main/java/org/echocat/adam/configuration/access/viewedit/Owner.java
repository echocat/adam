...
@XmlType(name = "accessViewEditOwner", namespace = SCHEMA_NAMESPACE)
public class Owner extends org.echocat.adam.configuration.access.view.Owner implements Rule {
