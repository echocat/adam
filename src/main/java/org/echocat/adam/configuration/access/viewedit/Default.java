...
@XmlType(name = "accessViewEditDefault", namespace = SCHEMA_NAMESPACE)
public class Default extends org.echocat.adam.configuration.access.view.Default implements Rule {
